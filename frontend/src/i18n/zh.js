...
const zh = {
  ...
  observatory: {
    ...
    tools: {
      ...
      close: '关闭面板',
      layersTitle: '图层',
      layersHint: '数据场、经纬网与底图',
      pointTitle: '点位探查',
      pointHint: '坐标输入、最近单元与点位结果',
      displayTitle: '显示与交互',
      displayHint: '自动旋转、视角重置、三维/二维与手势',
    },
    dataSource: {
      title: '数据源',
      planet: '星球',
      ...
      timeModel: '时间模型',
      aggregation: '聚合方式',
      officialDataset: '官方数据集',
      loading: '正在刷新数据源…',
      effectiveSource: '生效来源',
      ozoneDisplay: '臭氧显示方式',
      openMarsOzone: 'OpenMARS 臭氧数据',
      nomadOzone: 'NOMAD 臭氧数据',
    },
    layerPanel: {
      globeVariable: '球体变量',
      globeVariableAndOzone: '球体变量与臭氧图层',
      ozoneDisplay: '臭氧显示方式',
      globeLayers: '球体图层',
      globeLayersAndMarkers: '球体图层与辅助标记',
      showField: '数据场',
      graticule: '经纬网',
      coastline: '海岸线底图',
      analysisGroups: '分析分组',
      showQuality: '显示 3D 浓度',
      showAnnotations: '显示经纬度标注',
      showMarsTexture: '显示火星贴图',
      openMarsLayer: 'OpenMARS 臭氧图层',
      nomadLayer: 'NOMAD 臭氧图层',
      multiSourceDisabled: '当前数据源没有可用的多源图层。',
      validationDisabled: '当前数据源没有 NOMAD 稀疏验证点。',
      diffDisabled: '当前没有可用的差值对照。',
    },
    displayPanel: {
      rotationAndGesture: '旋转与手势控制',
      globeView: '球体视图',
      view3d: '三维球体',
      view2d: '二维地图',
      autoRotate: '自动旋转',
      autoRotateGlobe: '自动旋转球体',
      enableGesture: '启用手势控制',
      resetCamera: '重置视角',
    },
    point: {
      openPanel: '打开点位面板',
      ...
      cell: '实际单元中心',
      current: '当前值',
      empty: '在球体或二维地图上点击一个单元查看点位曲线；区域外点击只提示，不移动已有点位。',
      seriesTitle: '点位曲线与全球序列',
    },
    analysis: {
      dock: '底部分析区',
      groups: '分析分组',
      ...
      open: '展开分析',
      empty: '当前分组没有可用图表。',
      previewNote: '展开后主图会占满分析区宽度；这里只显示紧凑预览，不缩小完整图表。',
      unsupportedShort: '该分析在当前数据集上不可用，展开可查看原因与其它可选图表。',
      errorShort: '加载失败，展开分析可查看原因并重试。',
      aiTitle: 'AI 解读当前图表',
    },
    scene: {
      statusTitle: '当前观测条件',
